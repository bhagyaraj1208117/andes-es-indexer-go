...
import (
	...
	"github.com/bhagyaraj1208117/andes-es-indexer-go/client"
	...
	"github.com/bhagyaraj1208117/andes-es-indexer-go/process/elasticproc/factory"
...
func CreateElasticProcessor(
	...
	args := factory.ArgElasticProcessorFactory{
		...
		EnabledIndexes: []string{dataindexer.TransactionsIndex, dataindexer.LogsIndex, dataindexer.AccountsDCTIndex, dataindexer.ScResultsIndex,
			...
			dataindexer.OperationsIndex, dataindexer.DelegatorsIndex, dataindexer.DCTsIndex, dataindexer.SCDeploysIndex, dataindexer.MiniblocksIndex},
		Denomination: 18,
	}
