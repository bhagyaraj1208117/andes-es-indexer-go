...
func TestTransactionWithClaimRewardsGasRefund(t *testing.T) {
	...
	addressSender := "moa14wnzmpwhcm9up7lsrujcf7jne2lgnydcpkfwk0etlnndn5dcacksv84n0w"
	addressReceiver := "moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqplllsxxctf0"
