...
func TestAccountsProcessor_GetAccountsMOAXAccounts(t *testing.T) {
	t.Parallel()
...
func TestAccountsProcessor_PrepareAccountsMapMOAX(t *testing.T) {
	t.Parallel()
	...
	res := ap.PrepareRegularAccountsMap(123, []*data.Account{moaxAccount}, 0)
