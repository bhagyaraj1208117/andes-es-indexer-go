...
func TestTxsDatabaseProcessor_IssueDCTTx(t *testing.T) {
	...
	pubKeyConv, _ := pubkeyConverter.NewBech32PubkeyConverter(32, "moa")
	...
	pool := &outport.TransactionPool{
		Transactions: map[string]*outport.TxInfo{
			hex.EncodeToString([]byte("t1")): {Transaction: &transaction.Transaction{
				SndAddr: decodeBech32("moa1dglncxk6sl9a3xumj78n6z2xux4ghp5c92cstv5zsn56tjgtdwpsmdu0lq"),
				RcvAddr: decodeBech32("moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzllls29jpxv"),
