...
def prepare_observer(shard_id, working_dir, config_folder):
    ...
    shutil.copyfile(working_dir / "andes-go/cmd/node/node", working_dir_observer / "node/node")
...
def generate_new_config(working_dir):
    mx_chain_go_folder = working_dir / "andes-go" / "scripts" / "testnet"
...
def clone_mx_chain_go(working_dir):
    print("cloning andes-go....")
    mx_chain_go_folder = working_dir / "andes-go"
...
def prepare_proxy(working_dir):
    ...
    mx_chain_proxy_go_folder = working_dir / "andes-proxy-go"
...
def generate_config_for_local_testnet(working_dir):
    mx_chain_local_testnet_scripts = working_dir / "andes-go/scripts/testnet"
